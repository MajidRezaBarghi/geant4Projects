...
void Proj1RunAction::BeginOfRunAction(const G4Run*)
{
...
void Proj1RunAction::EndOfRunAction(const G4Run* run)
{
  ...
  const Proj1PrimaryGeneratorAction* generatorAction
   = static_cast<const Proj1PrimaryGeneratorAction*>
...
void Proj1RunAction::AddEdep(G4double edep)
{
  fEdep  += edep;
  fEdep2 += edep*edep;
}
