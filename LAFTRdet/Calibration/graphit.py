...
plt.title("Energy Deposited in Plastic Scintilator by Eu-152 Decay Spectra")
...
plt.ylabel("counts/keV")
plt.xlabel("Energy (keV)")
plt.title("Convolved Energy Deposited in Plastic Scintilator by Eu-152 Decay Spectra")
plt.plot(xf,c)
